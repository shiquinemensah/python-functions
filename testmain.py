def sayhi(name):
    print('hello ' + name ) # to create a function you would need to use 'def' and assign  it a value
    print('hello' + name + ', you are' + str(age))
                        # when that has been created python naturally creates an indentation // so anything within that
